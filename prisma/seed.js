...
async function main() {
  ...
  const hero = await prisma.hero.create({
    data: {
      ...
      subtitle_id:
        "Full-Stack Developer yang berfokus pada pembuatan aplikasi web elegan dan berkinerja tinggi.",
      cta_en: "View My Work",
  ...
  await prisma.about.create({
    data: {
      description_en:
        "I'm a passionate full-stack developer with over 3 years of experience building modern web applications. I specialize in React, Next.js, and Node.js, and I love creating elegant solutions to complex problems.",
      description_id:
        "Saya adalah full-stack developer yang bersemangat dengan pengalaman lebih dari 3 tahun membangun aplikasi web modern. Saya mengkhususkan diri dalam React, Next.js, dan Node.js, dan saya suka menciptakan solusi elegan untuk masalah yang kompleks.",
    },
  });
  ...
  await prisma.project.create({
    data: {
      ...
      description_id:
        "Platform e-commerce lengkap yang dibangun dengan Next.js dan PostgreSQL.",
  ...
  await prisma.experience.create({
    data: {
      ...
      description_en:
        "Leading frontend development for enterprise clients, designing Neo-Brutalist design systems, and improving load speeds by 40%.",
      description_id:
        "Memimpin pengembangan frontend untuk klien enterprise, merancang sistem desain Neo-Brutalist, dan meningkatkan kecepatan pemuatan hingga 40%.",
      published: true,
      order: 1,
    },
  });
